...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Compte créé avec succès', type: auth_dto_1.AuthResponseDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Se connecter à un compte existant' }),
